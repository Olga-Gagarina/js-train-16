...
function filterStudentsByGrade(students, grade) {
  console.error("Error: якщо ви бачите це повідомлення завдання 1 виконано не правильно");
  console.clear();
  ...
  for( const student of filteredStudents ){
    ...
    {  console.table([student],[ "name" , "grade"]);}
...
function compareArrays(arr1, arr2) {
  if (arr1.length !== arr2.length){
    console.assert(false," Масиви мають різну довжину!");
   
  }
  
  let arrSorted1 = arr1.sort();
  let arrSorted2 = arr2.sort();
 const arrAys = JSON.stringify(arrSorted1) === JSON.stringify(arrSorted2);
 
  console.assert(arrAys ," Масиви не однакові!" );
